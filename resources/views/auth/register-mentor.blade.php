    ...
    <div class="max-w-5xl mx-auto">
        ...
        <form action="{{ route('register.mentor.post') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="flex flex-col items-center gap-5 pt-4">
                <button type="submit" class="w-full md:w-72 py-4 bg-[#A487F8] text-white rounded-xl font-bold text-base hover:bg-[#947ADF] transition-all shadow-lg active:scale-95">
                    Buat Akun
                </button>
