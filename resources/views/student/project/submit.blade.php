    ...
    <div class="w-full h-full p-8">
        ...
        <div class="w-full grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-7 bg-[#1c1826] rounded-2xl border border-gray-800 p-8 flex flex-col">
                <div class="flex items-center gap-3 mb-6">
                    <div class="w-8 h-8 rounded-lg bg-[#7C3AED]/20 text-[#A487F8] flex items-center justify-center text-sm">
                ...
                <button class="mt-6 w-full py-3 bg-[#A487F8] hover:bg-[#947ADF] text-white text-[10px] font-bold rounded-lg uppercase tracking-widest transition-all">
                    Kirim
                </button>
            </div>
