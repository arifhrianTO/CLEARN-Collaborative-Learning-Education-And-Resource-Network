                ...
                <div class="lg:col-span-8">
                    <div class="bg-white dark:bg-[#1A1625] border border-gray-100 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                        ...
                        <div class="mt-8 flex justify-between items-center pt-4 border-t border-slate-100 dark:border-slate-800">
                            ...
                            @if(!$isLast)
                                <a href="?q={{ $currentSoal + 1 }}" class="px-5 py-2 bg-[#A487F8] hover:bg-[#8B6FE8] text-white text-[9px] font-black rounded-lg uppercase tracking-widest shadow-lg shadow-[#A487F8]/20 transition-all">
