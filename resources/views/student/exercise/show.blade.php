...
@section('content')
    <div class="flex w-full h-[calc(100vh)] overflow-hidden bg-slate-50 dark:bg-[#0b0a1a]">
        ...
        <main class="flex-1 w-full h-full overflow-y-auto p-6 lg:p-8 transition-colors duration-300 dark:bg-[#0b0a1a] bg-slate-50 custom-scrollbar">
            <div class="max-w-5xl mx-auto">
                ...
                <div class="mb-6">
                    <h1 class="text-2xl font-black text-slate-800 dark:text-white mb-2">Latihan: {{ $exercise->exercise_title }}</h1>
    ...
    function submitForm() {
        ...
        if (confirm('Apakah Anda yakin ingin mengirimkan jawaban? Anda tidak bisa mengulangnya lagi.')) {
            for (let i = 1; i <= {{ $totalSoal }}; i++) {
