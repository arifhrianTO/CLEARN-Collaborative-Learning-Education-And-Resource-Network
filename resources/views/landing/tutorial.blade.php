...
<head>
    ...
    @layer components {
        ...
        .dark .card-landing {
            @apply bg-[#1a1932] border-white/5 shadow-none hover:border-[#A487F8]/30;
        }

        .btn-gradient-glow {
            @apply bg-gradient-to-r from-[#A487F8] to-[#8B6FE8] text-white shadow-lg;
            box-shadow: 0 4px 15px rgba(164, 135, 248, 0.4);
            transition: all 0.3s ease;
        }
        .btn-gradient-glow:hover {
            @apply -translate-y-0.5;
            box-shadow: 0 8px 25px rgba(164, 135, 248, 0.5);
        }
    ...
    .glow-center {
        ...
        background: rgba(164, 135, 248, 0.15);
    }
    .dark .glow-center {
        background: rgba(164, 135, 248, 0.1);
    }
</style>
</head>
...
<main class="bg-slate-50 dark:bg-[#0F0B1A] text-slate-900 dark:text-white">
  ...
  <section class="px-6 pb-24">
      <div class="max-w-6xl mx-auto bg-[#A487F8] rounded-3xl text-center py-20 px-10">
