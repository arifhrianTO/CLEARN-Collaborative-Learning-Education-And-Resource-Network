<div class="bg-white dark:bg-[#13111a] p-8 rounded-3xl text-center border border-slate-200 dark:border-gray-800 hover:border-purple-600 transition-all shadow-md">
    ...
    <p class="text-xs text-purple-600 dark:text-purple-400 mb-6 font-semibold tracking-wider">Mentor Web Development</p>
...
<div class="bg-white dark:bg-[#13111a] p-8 rounded-3xl text-center border border-slate-200 dark:border-gray-800 hover:border-purple-600 transition-all shadow-md">
    ...
    <p class="text-xs text-purple-600 dark:text-purple-400 mb-6 font-semibold tracking-wider">Mentor UI/UX Design</p>
    <div class="text-xs text-slate-500 border-t border-slate-100 dark:border-gray-800/50 pt-5 space-y-1">
        <p>6 Pelajar</p>
        <p>2 Kursus</p>
    </div>
...
<div class="bg-white dark:bg-[#13111a] p-8 rounded-3xl text-center border border-slate-200 dark:border-gray-800 hover:border-purple-600 transition-all shadow-md">
    ...
    <p class="text-xs text-purple-600 dark:text-purple-400 mb-6 font-semibold tracking-wider">Mentor Data Science</p>
    <div class="text-xs text-slate-500 border-t border-slate-100 dark:border-gray-800/50 pt-5 space-y-1">
        <p>4 Pelajar</p>
        <p>5 Kursus</p>
    </div>
...
<div class="bg-white dark:bg-[#13111a] p-8 rounded-3xl text-center border border-slate-200 dark:border-gray-800 hover:border-purple-600 transition-all shadow-md">
    ...
    <p class="text-xs text-purple-600 dark:text-purple-400 mb-6 font-semibold tracking-wider">Mentor Digital Marketing</p>
    <div class="text-xs text-slate-500 border-t border-slate-100 dark:border-gray-800/50 pt-5 space-y-1">
        <p>8 Pelajar</p>
        <p>3 Kursus</p>
    </div>
