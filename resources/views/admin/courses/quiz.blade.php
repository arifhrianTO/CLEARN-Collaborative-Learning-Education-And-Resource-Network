    ...
    <main class="flex-1 p-6 lg:p-10 bg-slate-50 dark:bg-[#0b0a1a] min-h-screen">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-[#1c1826] border border-gray-100 dark:border-gray-800 rounded-3xl p-6 shadow-sm">
                    <div class="flex justify-between items-start mb-4">
                        <span class="text-[9px] font-black uppercase text-[#A487F8] tracking-widest bg-[#7C3AED]/10 px-2 py-1 rounded">Soal #{{ $i }}</span>
                    </div>
            ...
            <div class="mt-10 pt-8 border-t border-gray-200 dark:border-gray-800 flex justify-center">
                <button type="button" 
                        class="px-10 py-4 bg-[#A487F8] hover:bg-[#947ADF] text-white text-xs font-black uppercase tracking-widest rounded-2xl shadow-lg shadow-[#A487F8]/20 transition-all">
                    Selesai Tinjau
                </button>
            </div>
        </div>
