...
@section('title', 'Tambah Kategori Kursus | Dashboard Admin | Clearn - Platform Pembelajaran Online')
            ...
            <div class="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-[10px] dark:text-slate-500 text-slate-400 font-medium mt-0.5">
                        Tambahkan kategori kursus baru beserta ikon identitasnya.
                    </p>
                </div>
                    ...
                    <div class="md:col-span-2 space-y-6">
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-3">
                                ...
                                <input type="text"
                                    id="iconInput"
                                    name="category_icon"
                                    value="{{ old('category_icon', 'fa-book') }}"
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <input type="color"
                                    id="colorInput"
                                    name="category_color"
                                    value="{{ old('category_color', '#7C3AED') }}"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Berikan deskripsi singkat kategori...">{{ old('category_description') }}</textarea>
                    ...
                    <div class="md:col-span-1 flex flex-col gap-6 h-full">
                        ...
                        <div class="flex flex-col items-center justify-center p-4 bg-slate-50 dark:bg-[#0f0a19] border-2 border-dashed border-slate-200 dark:border-white/10 rounded-2xl flex-grow">
                            ...
                            <div class="w-20 h-20 bg-white dark:bg-[#161525] rounded-xl flex items-center justify-center border dark:border-white/5 shadow-sm">
                                <i id="iconPreview"
                                    class="fas {{ old('category_icon', 'fa-book') }} text-3xl"
                                    style="color: {{ old('category_color', '#7C3AED') }};">
                                </i>
                            </div>
